    ...
    <section id="overview" className="py-6 sm:py-14 md:py-16 px-4 sm:px-6 relative z-10 max-w-5xl mx-auto text-center border-t border-white/5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-5 text-left">
        <ScrollReveal delay={0.1}>
          <div className="bg-zinc-900/40 border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 h-full backdrop-blur-sm">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center mb-3">
              <Target className="w-5 h-5" />
            </div>
            <h3 className="text-sm sm:text-base font-bold text-white mb-1 font-display">Competitive Excellence</h3>
        ...
        <ScrollReveal delay={0.2}>
          <div className="bg-zinc-900/40 border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 h-full backdrop-blur-sm">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 flex items-center justify-center mb-3">
              <Zap className="w-5 h-5" />
            </div>
            <h3 className="text-sm sm:text-base font-bold text-white mb-1 font-display">Fast Communication</h3>
            <p className="text-zinc-400 text-[11px] sm:text-xs font-sans leading-relaxed">
        ...
        <ScrollReveal delay={0.3}>
          <div className="bg-zinc-900/40 border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 h-full backdrop-blur-sm">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center mb-3">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h3 className="text-sm sm:text-base font-bold text-white mb-1 font-display">Fair Play & Integrity</h3>
            <p className="text-zinc-400 text-[11px] sm:text-xs font-sans leading-relaxed">
