...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-[75vh] sm:min-h-[85vh] flex items-center justify-center overflow-hidden pt-16 pb-8 sm:pt-24 sm:pb-12 px-4 sm:px-6">
      {/* Background Glows */}
      <div className="absolute top-1/3 left-1/4 -translate-y-1/2 w-64 sm:w-96 h-64 sm:h-96 bg-amber-500/15 rounded-full blur-[100px] sm:blur-[140px] pointer-events-none" />
      <div className="absolute top-1/3 right-1/4 -translate-y-1/2 w-64 sm:w-96 h-64 sm:h-96 bg-cyan-500/15 rounded-full blur-[100px] sm:blur-[140px] pointer-events-none" />
      <div className="absolute inset-0 bg-[radial-gradient(#ffffff08_1px,transparent_1px)] [background-size:20px_20px] sm:[background-size:24px_24px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-4 sm:mb-5 shadow-inner"
        >
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
          <span className="text-[10px] sm:text-xs font-bold tracking-wider sm:tracking-widest text-zinc-200 uppercase font-mono">
        ...
        >
          ...
          <button
            ...
            className="w-full sm:w-auto px-5 py-2.5 sm:px-5 sm:py-3 bg-white/5 hover:bg-white/10 text-white font-semibold text-xs sm:text-sm rounded-full border border-white/10 transition-all font-sans flex items-center justify-center gap-1.5 cursor-pointer"
          >
        ...
        >
          <div className="bg-zinc-900/60 border border-white/10 rounded-xl p-2 sm:p-3 backdrop-blur-sm flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-zinc-400 text-[10px] font-sans">Podium rewards</div>
            </div>
          </div>
          ...
          <div className="bg-zinc-900/60 border border-white/10 rounded-xl p-2 sm:p-3 backdrop-blur-sm flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-zinc-400 text-[10px] font-sans">No emulators</div>
            </div>
          </div>
